...
contacts <- subset(contacts, contacttype = 'E')
...
write.csv(customer_cells_training, file = "customer_cells_traning_random_14days_email.csv", append = FALSE, quote = TRUE,
          col.names = TRUE)

write.csv(customer_cells_test, file = "customer_cells_test_random_14days_email.csv", append = FALSE, quote = TRUE,
          col.names = TRUE)
