...
write.csv(customer_cells_2006_2007, file = "customer_cells_2006_2007_14days.csv", append = FALSE, quote = TRUE,
          col.names = TRUE)

write.csv(customer_cells_2005_2006, file = "customer_cells_2005_2006_14days.csv", append = FALSE, quote = TRUE,
          col.names = TRUE)
