...
carte_coeff <- carte_incl_loss$coefficients
...
douwe_coeff <- douwe_incl_loss$coefficients
...
kenco_coeff <- kenco_incl_loss$coefficients
...
nescafe_coeff <- nesca_incl_loss$coefficients
...
other_coeff <- other_incl_loss$coefficients
...
super_coeff <- super_incl_loss$coefficients
